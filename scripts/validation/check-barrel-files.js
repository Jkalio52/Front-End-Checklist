...
const ALLOWED_INDEX_FILES = [
  ...
  // MCP component barrel – single cohesive module re-exports for external use
  'apps/web/src/components/mcp/index.ts',
  // MCP tools barrel – package public API surface for tools
  'packages/mcp/src/tools/index.ts',
  // Config package public API surface
