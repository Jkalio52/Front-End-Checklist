...
/**
 * Validates TypeScript type usage and best practices
 */
class TypeValidator {
  ...
  private checkUnusedTypes(_file: string, line: string, _lineNumber: number): void {
...
/**
 * Validate TypeScript types in multiple files
